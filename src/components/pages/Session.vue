<template>
  ...
  export default {
    ...
    handleFileUpload(event) {
        ...
        // Convert FileList to Array to ensure we can use array methods like filter()
        ...
        const trcFiles = filesArray.filter(file => file.name.toLowerCase().endsWith('.trc'));
        const osimFiles = filesArray.filter(file => file.name.toLowerCase().endsWith('.osim'));
        const motFiles = filesArray.filter(file => file.name.toLowerCase().endsWith('.mot'));
